...
const insertRandomData = async () => {
  try {
    ...
    // await connection.promise().query(`
    //           INSERT INTO products (name, price, created_at)
    //           VALUES ('Apple iPhone 12', 699.99, '2024-09-15 10:30:00'),
    //                  ('Samsung Galaxy S20', 499.99, '2024-09-20 11:00:00'),
    //                  ('Dell XPS 13 Laptop', 1099.99, '2024-10-05 09:45:00'),
    //                  ('AirPods Max', 599.99, '2024-10-12 14:20:00')
    // `);
    //
    // await connection.promise().query(`
    //           INSERT INTO orders (customer, status, order_date)
    //           VALUES ('Jānis Bērziņš', 'Shipped', '2024-11-01 12:15:00'),
    //                  ('Dwayne Johnson', 'Delivered', '2024-11-05 10:05:00'),
    //                  ('Robert Brown', 'Shipped', '2024-11-07 16:30:00'),
    //                  ('Kristaps Bērziņš', 'Processing', '2024-11-03 15:40:00'),
    //                  ('Emily Davis', 'Shipped', '2024-11-10 11:25:00')
    // `);
    //
    // await connection.promise().query(`
    //           INSERT INTO customer_insights (report_date, total_customers, new_customers, monthly_active)
    //           VALUES ('2024-11-01', 250, FLOOR(RAND()*(10-5+1)+5), 180)
    // `);
    //
    // await connection.promise().query(`
    //           INSERT INTO promo_codes (code, description, discount_percentage, created_at)
